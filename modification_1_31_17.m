...
%                              lsqfit(variation_numb+1,2) = str2num(rawCellColumns{i,4});
                  ...
                  elseif variation_numb == 3
                             ...
                             lsqfit(variation_numb+1,1) = str2num(rawCellColumns{i,2})*0.5;
                             lsqfit(variation_numb+1,2) = str2num(rawCellColumns{i,4});
                  elseif variation_numb == 4
                             ...
                             lsqfit(variation_numb+1,1) = str2num(rawCellColumns{i,2})*7.5;
                  ...
                  elseif variation_numb == 5
                             ...
                             rawCellColumns2{i,4} = str2num(rawCellColumns{i,4})+2000; % E+2000
                             lsqfit(variation_numb+1,1) = str2num(rawCellColumns{i,2})*1.6;% A>1 
                             lsqfit(variation_numb+1,2) = str2num(rawCellColumns{i,4})+2000; % E+2000
                             
                  elseif variation_numb == 6
                             rawCellColumns2{i,9} =  ['!***ClASS',num2str(class_numb),'***','v_',num2str(variation_numb)];
                             rawCellColumns2{i,2} = str2num(rawCellColumns{i,2})*0.6; % A<1  
                             rawCellColumns2{i,4} = str2num(rawCellColumns{i,4})-2000; % E-2000 
                             lsqfit(variation_numb+1,1) = str2num(rawCellColumns{i,2})*0.6;
                             lsqfit(variation_numb+1,2) = str2num(rawCellColumns{i,4})-2000;
